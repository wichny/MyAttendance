...
public class CheckIn extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseLocationDetails = FirebaseDatabase.getInstance().getReference().child("Attendance").child("Check-In").push();
...
//      permission check
        ...
        mSpinTime.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (tim.equals("Select time")) {
                    Toast.makeText(CheckIn.this, "Please Select Session!", Toast.LENGTH_SHORT).show();
                }
                if (tim == "8 am") {
                    tim = String.valueOf(tim.charAt(0));
                    Toast.makeText(CheckIn.this, tim + "", Toast.LENGTH_SHORT).show();
                }
                if (tim == "12 pm") {
    ...
    private void enable_button() {
        ...
        mLocationBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                gps = new GPS_Service(CheckIn.this, tim);
                startService(new Intent(CheckIn.this, GPS_Service.class));
    ...
    private boolean runtime_permission() {
        if (Build.VERSION.SDK_INT >= 23 && ContextCompat.checkSelfPermission(CheckIn.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(CheckIn.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
